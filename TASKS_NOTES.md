...
1. Circuit Breaker
2. Prevents total system failure when a service (like SMTP or FCM) goes down.
3. Retry System
...
Each team must submit a simple diagram showing: Service connections, Queue structure, Retry and failure flow, Database relationships, Scaling plan.</br>
